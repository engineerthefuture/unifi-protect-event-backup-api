...
namespace UnifiWebhookEventReceiver.Configuration
{
    ...
    public static string? SummaryEventQueueUrl => Environment.GetEnvironmentVariable("SummaryEventQueueUrl");
        ...
        /// <summary>Additional seconds to wait for video page to fully load before attempting download (defaults to 10 seconds)</summary>
        public static int VideoPageLoadDelaySeconds => int.TryParse(Environment.GetEnvironmentVariable("VideoPageLoadDelaySeconds"), out var delay) ? delay : 10;
